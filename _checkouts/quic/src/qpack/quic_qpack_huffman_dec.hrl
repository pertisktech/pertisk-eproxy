...
%%% Original implementation from cowlib (https://github.com/ninenines/cowlib)
%%%
...
%%%
%%% @doc Huffman decoding state machine for QPACK (RFC 9204).
%%%
%%% RFC 7541 Appendix B defines the Huffman code table used by both
%%% HPACK (HTTP/2) and QPACK (HTTP/3). This lookup table implements
%%% a state machine for efficient decoding, processing 4 bits at a time.
%%% @end
